...
map.getView().fit([-966809.704203, 5252220.819894, -965266.453031, 5253038.593172], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Traída Comunidade  Usuarios "As Rociñas"</h2>';
        return titleElement;
    })(),
